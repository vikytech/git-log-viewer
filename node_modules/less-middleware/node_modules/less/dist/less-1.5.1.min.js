...
!function (a, b) {
    ...
    w === b && (w = exports, x = c("./tree"), w.mode = "node"), w.Parser = function (a) {
        ...
        function o(a, b, d) {
            ...
            return"browser" !== w.mode && "rhino" !== w.mode && (e = c("path").resolve(e)), {lineNumber: n(a, b).line + 1, fileName: e}
        }
        ...
        var C = this.imports = {paths: a.paths || [], queue: [], files: a.files, contents: a.contents, mime: a.mime, error: null, push: function (b, c, d, e) {
            var f = this;
            this.queue.push(b);
        ...
        return p.prototype = new Error, p.prototype.constructor = p, this.env = a = a || {}, this.optimization = "optimization"in this.env ? this.env.optimization : 1, A = {imports: C, parse: function (b, d) {
            var e, f, g, i = null;
            if (r = s = z = v = 0, q = b.replace(/\r\n/g, "\n"), q = q.replace(/^\uFEFF/, ""), A.imports.contents[a.currentFileInfo.filename] = q, y = function (b) {
                ...
                return 0 !== l && (i = new p({index: n - 1, type: "Parse", message: l > 0 ? "missing closing `}`" : "missing opening `{`", filename: a.currentFileInfo.filename}, a)), b.map(function (a) {
                    return a.join("")
                })
            }([
                []
            ...
            if (e.toCSS = function (b) {
                ...
                r = v;
                var k = n(r, q);
                g = q.split("\n"), f = k.line + 1, i = {type: "Parse", message: "Unrecognised input", index: r, filename: a.currentFileInfo.filename, line: f, column: k.column, extract: [g[f - 2], g[f - 1], g[f]]}
            }
            var l = function (b) {
            ...
            for (var b, c, d, e, f, g, i = [], l = [], m = [], n = {args: null, variadic: !1}; ;) {
                ...
                if (a ? 1 == g.value.length && (o = g.value[0]) : o = g, o && o instanceof x.Variable)if (h(":"))i.length > 0 && (b && k("Cannot mix ; and , as delimiter types"), c = !0), f = j(this.expression), e = d = o.name; else {
                    if (!a && h(/^\.{3}/)) {
                        n.variadic = !0, h(";") && !b && (b = !0), (b ? l : m).push({name: g.name, variadic: !0});
                        break
                    }
                    a || (d = e = o.name, f = null)
                }
                f && i.push(f), m.push({name: e, value: f}), h(",") || (h(";") || b) && (c && k("Cannot mix ; and , as delimiter types"), b = !0, i.length > 1 && (f = new x.Value(i)), l.push({name: d, value: f}), d = null, i = [], c = !1)
            }
        ...
        d.functions = {rgb: function (a, b, c) {
            ...
            var h = [c, c * (1 - b), c * (1 - f * b), c * (1 - (1 - f) * b)], i = [
                [0, 3, 1],
                [2, 0, 1],
                [1, 0, 3],
                [1, 2, 0],
