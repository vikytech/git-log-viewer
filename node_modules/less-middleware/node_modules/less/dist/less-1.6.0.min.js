...
!function (a, b) {
    ...
    v === b && (v = exports, w = c("./tree"), v.mode = "node"), v.Parser = function (a) {
        ...
        return t.prototype = new Error, t.prototype.constructor = t, this.env = a = a || {}, this.optimization = "optimization"in this.env ? this.env.optimization : 1, F = {imports: I, parse: function (d, e, f) {
            ...
            for (var a, b = this.mixin, c = J, d = []; ;)if (a = this.extendRule() || b.definition() || this.rule() || this.ruleset() || b.call() || this.comment() || this.directive())d.push(a); else if (!c(/^[\s\n]+/) && !c(/^;+/))break;
            return d
        }, comment: function () {
            var b;
            ...
            var b, c, f, g, h, k = u.charAt(x), l = !1, n = x;
            if ("." === k || "#" === k) {
                for (d(); ;) {
            ...
            for (var c, d, e, f, g, h, i, j = J; (b && (g = this.extend()) || b && (h = j(/^when/)) || (f = this.element())) && (h ? i = l(this.conditions, "expected condition") : i ? n("CSS guard can only be used at the end of selector") : g ? d ? d.push(g) : d = [g] : (d && n("Extend can only be used at the end of selector"), e = u.charAt(x), c ? c.push(f) : c = [f], f = null), "{" !== e && "}" !== e && ";" !== e && "," !== e && ")" !== e););
        ...
        a.mixin = {}, a.mixin.Call = function (b, c, d, e, f) {
            ...
            for (e = this.arguments && this.arguments.map(function (a) {
                ...
                for (j = !0, g = 0; g < c.length; g++) {
                    ...
                    if (!i && d.matchArgs(e, b)) {
                        if (l = {mixin: d}, d.matchCondition) {
                            ...
                            if (p[0] || p[1]) {
                                if (p[0] != p[1]) {
                                    if (r)throw{type: "Runtime", message: "Ambiguous use of `default()` found when matching for `" + this.format(e) + "`", index: this.index, filename: this.currentFileInfo.filename};
                ...
                q.reset();
                for (g in o)if (l = o[g], !l.matchIfDefault || l.matchIfDefaultValue == (1 == o.length))try {
    ...
    if (v.logLevel = "undefined" != typeof v.logLevel ? v.logLevel : y.info, v.async = v.async || !1, v.fileAsync = v.fileAsync || !1, v.poll = v.poll || (x ? 1e3 : 1500), v.functions)for (var z in v.functions)v.tree.functions[z] = v.functions[z];
